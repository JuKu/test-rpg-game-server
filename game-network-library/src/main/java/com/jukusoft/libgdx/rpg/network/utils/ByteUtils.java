...
public class ByteUtils
{
	...
	*/
	 ...
	 *            charset
	 */
	public static String getStringFromMessage(NetMessage message, Charset charset) {
		byte[] bytes = new byte[message.content().readableBytes()];

		// read bytes from ByteBuf InputStream
		message.content().readBytes(bytes);

		String str = ByteUtils.getStringFromBytes(bytes, charset);
		return str;
	}
	 ...
	 *            charset
	 */
	public static String getStringFromByteBuf (ByteBuf byteBuf, Charset charset) {
	...
	public static ByteBuf getByteBuf (String str) {
		...
		byteBuf.writeBytes(ByteUtils.getBytesFromString(str));
